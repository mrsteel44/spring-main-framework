...
public class CybertekAppConfig {
    ...
    // if you dont want to use @Component java and selenium classes then we can use @Bean on this page with methods

    @Bean
    public Java java(){
        return new Java(exstraSessions());
    }
    ...
    //@Bean
    public ExstraSessions exstraSessions(){
        return new OfficeHours();
    }
